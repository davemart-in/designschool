...
<head>
	...
	<title><?php echo $data["leadership"]['ownership']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of establishing clear lanes of ownership">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['ownership']['title']; ?></h1>
				<?php
