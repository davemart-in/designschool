...
<head>
	...
	<title><?php echo $data["leadership"]['stewardship']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of asking designers to take stewardship over pages or flows within your app">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['stewardship']['title']; ?></h1>
				<?php
