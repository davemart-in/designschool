...
<head>
	...
	<title><?php echo $data["leadership"]['hours']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of office hours">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['hours']['title']; ?></h1>
				<?php
