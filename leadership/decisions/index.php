...
<head>
	...
	<title><?php echo $data["leadership"]['decisions']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of giving everyone a chance to weigh in">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['decisions']['title']; ?></h1>
				<?php
