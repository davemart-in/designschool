...
<head>
	...
	<title><?php echo $data["leadership"]['daily']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of sharing your work in daily journals">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['daily']['title']; ?></h1>
				<?php
