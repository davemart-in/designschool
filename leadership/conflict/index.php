...
<head>
	...
	<title><?php echo $data["leadership"]['conflict']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of resolving conflicts">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['conflict']['title']; ?></h1>
				<?php
