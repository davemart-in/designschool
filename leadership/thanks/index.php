...
<head>
	...
	<title><?php echo $data["leadership"]['thanks']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of saying thank you frequently">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['thanks']['title']; ?></h1>
				<?php
