...
<head>
	...
	<title><?php echo $data["leadership"]['iterations']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of having multiple iterations">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['iterations']['title']; ?></h1>
				<?php
