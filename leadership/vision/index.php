...
<head>
	...
	<title><?php echo $data["leadership"]['vision']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of sharing a clear vision">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['vision']['title']; ?></h1>
				<?php
