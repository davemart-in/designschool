...
<head>
	...
	<title><?php echo $data["leadership"]['safety']['title']; ?> - Design leadership</title>
	<meta name="description" content="The importance of psychological safety">
...
<body>
	...
	<main>
		...
		<article>
			<hgroup>
				<h1><?php echo $data["leadership"]['safety']['title']; ?></h1>
				<?php
