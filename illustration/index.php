...
<?php $course = 'illustration'; ?>
<?php $course_name = 'Illustration'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<meta name="description" content="The importance of <?php echo $course_name; ?>">
	...
	<main>
		...
		<article>
			<hgroup>
				...
				<h2>Learn the basics of incorporating illustration into the products you build. This course is 100% free.</h2>
			</hgroup>
