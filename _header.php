<div class="share">
	<p>Share</p>
	<a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('If you’re a product designer or an aspiring product designer, you should check this site out.');?>&url=http%3A%2F%2Fdesignschool.org%2F" class="twitter" target="_blank" aria-label="Share on Twitter" rel="nofollow">
	...
	<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fdesignschool.org%2F" class="facebook" target="_blank" aria-label="Share on Facebook" rel="nofollow">
...
<div class="modal_backdrop">
	<div class="modal">
		...
		<div class="modal_body">
		    ...
		    <ol>
		        <li>Click the <a href="https://github.com/davemart-in/designschool/edit/main<?php echo $_SERVER['REQUEST_URI']; ?>index.php" target="_blank">Edit this page</a> link below</li>
		...
		<div class="modal_footer">
		    <a href="https://github.com/davemart-in/designschool/edit/main<?php echo $_SERVER['REQUEST_URI']; ?>index.php" class="btn btn--primary btn--lg" target="_blank">Edit this page</a>
		</div>
	</div>
</div>
<header>
	<section>
		<a href="/" aria-label="Return home"><img src="/img/design-school.png" height="124" width="124" alt="logo"></a>
		<h3>Design School</h3>
